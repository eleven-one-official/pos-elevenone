    ...
    try {
      if (kind === 'orders') {
        ...
        await downloadTablePdf({
          ...
          landscape: true,
          // Fixed widths (No 10 + columns = 269mm landscape content width) so
          // the cells print evenly instead of auto-sizing to their content —
          // same treatment as the Sales Details export below.
          columns: [
            { header: 'Order #', width: 36 },
            { header: 'Date', width: 23 },
            { header: 'Time', width: 15 },
            { header: 'Type', width: 24 },
            { header: 'Table', width: 18 },
            { header: 'Staff', width: 29 },
            { header: 'Guests', align: 'right', width: 15 },
            { header: 'Items', align: 'right', width: 14 },
            { header: 'Subtotal', align: 'right', width: 21 },
            { header: 'Discount', align: 'right', width: 21 },
            { header: 'Total', align: 'right', width: 21 },
